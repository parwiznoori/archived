...
class KankorResultsController extends Controller
{
    ...
    // }
        ...
        public function show_department()
            {   
                $kankorYear = Archivedata::max('kankor_year');
                $kankorResults = Archivedata::distinct()
                    ->where('kankor_year', $kankorYear)
                    ->where(function($query) {
                        $query->whereNull('department_id')
                            ->orWhereNull('university_id')
                            ->orWhereNull('archive_id');
                    })
                    ->pluck('kankor_result', 'kankor_result');
                ...
                return view('kankor_results.show_department', [
                    ...
                    'department' => old('department_id') ? Department::where('id', old('department_id'))->pluck('name', 'id') : [],
                    'descriptions' => ''
                ]);
            }
...
public function store_department(Request $request)
{
    ...
    \DB::transaction(function () use ($request) {            
        $students = Archivedata::where('kankor_year', $request->kankor_year)
    ...
    //     $kankorYear = Archivedata::max('kankor_year');
    //     $kankorResults = Archivedata::distinct('kankor_result')
    //     ->where('kankor_year',$kankorYear)
    ...
    //     \DB::transaction(function () use ($request, $kankor_year,$archive_id,$university_id,$department_id) {            
    //         $students = Archivedata::where('kankor_year',$kankor_year)
    //         ->where('kankor_result',$request->kankorResults)
