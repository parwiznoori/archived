...
class ArchiveuserDataTable extends DataTable
{
    /**
...
//                    $html .= '<li><a href="'. route('user.auth.log', $archiveuser).'"  target="new" title = "'. trans('general.auth_log').' " > <i class="fa fa-history"></i> '. trans("general.auth_log") .' </a></li>';
//
//                }
    ...
    public function query(User $model)
    {
        ...
        $archiveuser = User::select('id', 'name', 'position', 'email', 'phone','type','university_id', 'active')
            ->where('type', 2)
