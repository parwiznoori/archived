    ...
    <div class="col-md-12">
        ...
        <div class="portlet"> 
            ...
            <div class="portlet-body">
                ...
                @endif
                <!-- BEGIN FORM-->            
                {!! Form::open(['route' => 'kankor_results.store_university', 'method' => 'post', 'class' => 'form-horizontal']) !!}
                    ...
                    <div class="row">   
                        <div class="col-md-12">
                            <div class="form-group {{ $errors->has('kankorResults') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-8">
                                    {!! Form::select('kankorResults[]', $kankorResults, null, ['class' => 'form-control select2','multiple' => 'multiple']) !!}
