...
@section('content')
    <div class="portlet box">
        <div class="portlet-body">
            {!! Form::model($archiveRole, ['route' => ['archiverole.update', $archiveRole->id], 'method' => 'put', 'class' => 'form-horizontal']) !!}
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('university_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                {!! Form::select('university_id', $universities, $archiveRole->archive->university_id ?? null, [
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group {{ $errors->has('user_id') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-8">
                                {!! Form::select('user_id', $archiveUsers->pluck('name', 'id'), null,['class' => 'form-control select2-ajax-archive-user',
                ...
                <div class="col-md-6">
                    <div class="form-group {{ $errors->has('archive_id') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-8">
                         ...
                         {!! Form::select(
                            'archive_id[]',
                            [$archiveRole->archive->id => $archiveRole->archive->book_name],
                            [$archiveRole->archive->id],
                            [
