...
<div class="portlet box">
    <div class="portlet-body">
        <!-- BEGIN FORM-->
        {!! Form::open(['route' => ['departments.store', $university], 'method' => 'post', 'class' =>
        'form-horizontal']) !!}
        <div class="form-body">
            ...
            {{-- <div class="form-group {{ $errors->has('department_type') ? ' has-error' : '' }}">
                {!! Form::label('department_type', trans('general.department_type'), ['class' => 'control-label col-sm-3']) !!}
                <div class="col-sm-4">
                    {!! Form::select('department_type', ['Daily' => trans('general.Daily'), 'Nightly' => trans('general.Nightly')],
                    null, ['class' => 'form-control', 'placeholder' => trans('general.select')]) !!}
            ...
            <div class="form-group {{ $errors->has('department_type_id') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-4">
                    {!! Form::select('department_type_id',$departmentTypes,null, ['class' => 'form-control select2', 'placeholder' =>
            ...
            <div class="form-group {{ $errors->has('faculty_id') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-4">
                    {!! Form::select('faculty_id',$faculties,null, ['class' => 'form-control select2','placeholder' =>
                    trans('general.select') ]) !!}
            ...
            <div class="form-group {{ $errors->has('grade_id') ? ' has-error' : '' }}">
                ...
                <div class="col-sm-4">
                    {!! Form::select('grade_id', $grades, null, ['class' => 'form-control select2', 'placeholder' =>
                    trans('general.select')]) !!}
            ...
            <div class="row">
                <div class="col-md-offset-3 col-md-9">
                    ...
                    <a href="{{ route('departments.index', $university) }}"
                        class="btn default">{{ trans('general.cancel') }}
                    </a>
                </div>
            </div>
        </div>
