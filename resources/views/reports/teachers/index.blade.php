                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('active') ? ' has-error' : '' }}">
                                {!! Form::label('active', trans('general.active'), ['class' => 'control-label col-sm-3']) !!}
                                <div class="col-sm-8">
                                    {!! Form::select('active', [ 1 => trans('general.active'),  0 => trans('general.inactive') ], null, ['class' => 'form-control', 'placeholder' => trans('general.select')]) !!}
