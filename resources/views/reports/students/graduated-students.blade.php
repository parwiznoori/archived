<table>
    <thead>
    <tr>
        <th colspan="21">{{trans('general.graduated_students_list')}} </th>
    ...
    <tr>
        ...
        <th>{{trans('general.manual_graduated')}}</th>
    ...
    @foreach($students as $student)
        <tr>
            ...
            <td>{{ $student->manual_graduated == 1 ?  trans('general.individuals') : trans('general.system') }}</td>
