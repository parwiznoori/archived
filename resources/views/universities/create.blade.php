            ...
            {!! Form::open(['route' => 'universities.store', 'method' => 'post', 'class' => 'form-horizontal']) !!}            
                <div class="form-body">
                    ...
                    <div class="form-group {{ $errors->has('domain') ? ' has-error' : '' }}">
                        {!! Form::label('domain', trans('models/universities.fields.domain'), ['class' => 'control-label col-sm-3']) !!}                                
                        <div class="col-sm-4">
                    ...
                    <div class="form-group {{ $errors->has('address') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-4">
                            {!! Form::text('address', null, ['class' => 'form-control ltr']) !!}     
                    ...
                    <div class="form-group {{ $errors->has('website_url') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-4">
                            {!! Form::text('website_url', null, ['class' => 'form-control ltr']) !!}     
                    ...
                    <div class="form-group {{ $errors->has('phone_number') ? ' has-error' : '' }}">
                        ...
                        <div class="col-sm-4">
                            {!! Form::text('phone_number', null, ['class' => 'form-control ltr']) !!}     
