			...
			<tr>
				<td>
					<table class="table inner-table borderless" style >
						...
						<tr>
							<td style= "border:none ; padding-right:20px"><p> {{trans('general.student_name')}} :&nbsp; {{$student->getFullNameAttribute()}} &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; امضاّ  :&nbsp;<span>...................<span> &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span> {{trans('general.date')}} :
			...
			<tr>
				<td>
					<table class="table inner-table borderless" style >
						...
						<tr>
							<td style= "border:none ; padding-right:10px" ><p>{{trans('general.student_afair_request_to_faculty')}}</p></td><br>
						</tr>
						<tr>
							<td class= "center" style= "border:none ;" ><p>{{trans('general.with_respect')}}</p></td>
						</tr>
			...
			<tr>
				<td>
					<table class="table inner-table borderless"  >
						...
						<tr>
							<td  style= "border:none ; padding-right:10px" ><p></p><br></td>
						</tr>
						<tr>
