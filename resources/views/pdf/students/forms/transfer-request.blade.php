				...
				<td style="padding: 0">
					<table class="table inner-table">
						...
						<tr>
							...
							<td class style = "width:5%" >{{ $transfer->semester}}</td>
							<td class style = "width:9%" > 
                                @if(isset($transfer->from_department_id))
                                    @if(isset($transfer->fromDepartment->faculty_id))
                                        {{$transferData['fromFaculty']}}
                                    @endif
                                @endif
                            </td>
							<td class style = "width:9%" >{{$transferData['fromUniversity']}}</td>

							<td class style = "width:7%" ></td>						
                            <td class style = "width:7%" >{{ $transfer->semester}}</td>
							<td class style = "width:7%" >
								
                                @if(isset($transfer->toDepartment->faculty_id))
                                {{$transferData['toFaculty']}}
                                @endif
                              
							<td class style = "width:7%" >
								
								{{   $transferData['toUniversity']  }}</td>
				...
				<td style="padding:0px">
					<table class="table inner-table">
						...
						<tr>	
							...
							<td></td>
							<td>{{$transfer->semester}}</td>
							<td>
                                @if(isset($transfer->fromDepartment->faculty_id))
                                {{$transfer->fromDepartment->facultyName->name}}
                                @endif
                            </td>
							<td>
                                @if(isset($transfer->fromDepartment->name))
