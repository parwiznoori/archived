...
var App = function() {
    ...
    ajax: {
        url: function () {
            let base = $(".select2-two-paramter-ajax").attr('remote-url');
            let uParam = $($(".select2-two-paramter-ajax").attr('remote-param1')).val();
            let rParam = $($(".select2-two-paramter-ajax").attr('remote-param2')).val();

            // اگر هرکدام خالی بود مقدار خالی قرار بده
            if (!uParam) uParam = '';
            if (!rParam) rParam = '';
...
$(document).ready(function() {
    ...
    $(".select2-ajax").select2({
        ...
        ajax: {
            url: function (params) {
                return $(".select2-ajax").attr('remote-url') + ($(".select2-ajax").attr('remote-param') ? '/' + $($(".select2-ajax").attr('remote-param')).val() : '');
            },
            dataType: 'json',
            delay: 250,
            data: function(params) {
    ...
    $(".select2-d-ajax").select2({
        language: "fa",
        ajax: {
            url: function (params) {
                return $(".select2-d-ajax").data('remote-url');
            },
            data: function (params) {
                return {
                    q: params.term,
                    university_id: $('[name="university_id"]').val(),
                    faculty_id: $('[name="faculty_id"]').val()
                };
            },
            processResults: function(data) {
                return {
    ...
    //archivebook
    $(".select2-ajax-archive-book").select2({
        language: "fa",
        ajax: {
            url: function (params) {
                return $(".select2-ajax-archive-book").attr('remote-url') + ($(".select2-ajax-archive-book").attr('remote-param') ?
                    '/' + $($(".select2-ajax-archive-book").attr('remote-param')).val() : '');
            },
            dataType: 'json',
            delay: 250,
            data: function(params) {
...
//facultyfile
    $(".select2-ajax-faculty").select2({
        ...
        ajax: {
            url: function (params) {
                return $(".select2-ajax-faculty").attr('remote-url') + ($(".select2-ajax-faculty").attr('remote-param') ?
                    '/' + $($(".select2-ajax-faculty").attr('remote-param')).val() : '');
            },
            dataType: 'json',
            delay: 250,
            data: function(params) {
    ...
    $(".select2-students-with-department").select2({
        language: "fa",
        ajax: {
            url: function (params) {
                // return '/api/studentsWithDepartment';
                return $(".select2-students-with-department").attr('remote-url') + ($(".select2-students-with-department").attr('remote-param') ? '/' + $($(".select2-students-with-department").attr('remote-param')).val() : '');
            },
            dataType: 'json',
            delay: 250,
            data: function(params) {
