...
trait HasRoleAndPermission
{
    ...
    {   $teamId = $teamId ? $teamId : currentTeamId();
        //return $this->belongsToMany(config('rbac.models.role'))->withTimestamps()->withPivot('granted');
        return $this->belongsToMany(config('rbac.models.role'))->withTimestamps()->withPivot('granted', 'team_id')->wherePivot('team_id', $teamId);
    }
